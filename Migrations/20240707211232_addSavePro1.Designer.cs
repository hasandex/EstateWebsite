...
namespace EstateWebsite.Migrations
{
    ...
    [Migration("20240707211232_addSavePro1")]
    partial class addSavePro1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EstateWebsite.Models.SaveEstate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EstateWebsite.Models.SaveEstate", b =>
                {
                    b.HasOne("EstateWebsite.Models.Estate", "Estate")
                        .WithMany("SaveEstates")
                        .HasForeignKey("EstateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EstateWebsite.Models.AppUser", "Users")
                        .WithMany("SaveEstates")
